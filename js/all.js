  ...
  Post = (function(_super) {
        ...
        this.commenting ? h("div.comment-create", {
          ...
          return function(comment) {
            ...
            return h("div.comment", {
              ...
              ]), false ? _this.getEditableComment(comment_uri).render(comment.body) : ((_ref2 = comment.body) != null ? _ref2.length : void 0) > 5000 ? h("div.body.maxheight", {
    ...
    Post.prototype.render = function() {
      ...
      return h("div.post", {
        ...
        ]), false ? this.editable_body.render(this.row.body) : h("div.body", {
          classes: {
  ...
  UserList = (function(_super) {
    ...
    UserList.prototype.update = function() {
      ...
      if (this.followed_by) {
        ...
        query = "SELECT\n user.*,\n json.site AS json_site,\n json.directory AS json_directory,\n json.file_name AS json_file_name,\n json.cert_user_id AS json_cert_user_id,\n json.hub AS json_hub,\n json.user_name AS json_user_name,\n json.avatar AS json_avatar\nFROM\n user LEFT JOIN json USING (json_id)\nWHERE\n date_added < " + (Time.timestamp() + 120) + " AND user.hub = '1P1EZnxCLRh21hTe4GgR8cHK26KSXcYYy8'" + "\n " + search_where + "\nORDER BY date_added DESC\nLIMIT 30";
      }
